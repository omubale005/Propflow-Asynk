import type { 
  User, Lead, Builder, Project, InventoryUnit, SiteVisit, Booking, 
  Commission, Document, Payment, Communication, MessageTemplate,
  TelecallingCampaign, DashboardStats, ChartData
} from '@/types';
...
export const telecallingCampaigns: TelecallingCampaign[] = [
  {
    id: '1',
...
export const monthlyBookingsChartData: ChartData = {
...
export const leadStatusChartData: ChartData = {
