...
export const projects = [
  {
    ...
    description:
      "Luxury residential apartments in the heart of Mumbai with world-class amenities",
...
export const leads = [
  {
    ...
    notes: [
      {
        id: "1",
        content: "Client is looking for luxury apartment in South Mumbai",
        createdBy: "3",
    ...
    activities: [
      {
        id: "1",
        type: "call_made",
        description: "Initial call made, client interested",
        createdBy: "3",
        createdByName: "Amit Kumar",
        createdAt: new Date("2024-03-01"),
      },
      {
        id: "2",
        type: "site_visit",
        description: "Site visit scheduled for Lodha Park",
        createdBy: "3",
        createdByName: "Amit Kumar",
  ...
  },
  {
    ...
    notes: [
      {
        id: "2",
        content: "First time home buyer, needs guidance",
        createdBy: "4",
    ...
    activities: [
      {
        id: "3",
        type: "call_made",
        description: "Explained home loan process",
        createdBy: "4",
        createdByName: "Sneha Gupta",
        createdAt: new Date("2024-03-02"),
      },
  ...
  },
  {
    ...
    notes: [
      {
        id: "3",
        content: "High net worth individual, looking for investment",
        createdBy: "3",
        createdByName: "Amit Kumar",
    ...
    activities: [
      {
        id: "4",
        type: "site_visit",
        description: "Site visit completed at Lodha Park",
        createdBy: "3",
        createdByName: "Amit Kumar",
      ...
      },
      {
        id: "5",
        type: "meeting",
        description: "Negotiation meeting scheduled",
        createdBy: "3",
        createdByName: "Amit Kumar",
  ...
  },
  {
    ...
    notes: [
      {
        id: "4",
        content: "Ready to book, waiting for loan approval",
        createdBy: "3",
        createdByName: "Amit Kumar",
        createdAt: new Date("2024-03-05"),
      },
    ...
    activities: [
      {
        id: "6",
        type: "site_visit",
        description: "Liked Prestige Jindal City",
        createdBy: "3",
        createdByName: "Amit Kumar",
        createdAt: new Date("2024-03-04"),
      },
      {
        id: "7",
        type: "call_made",
        description: "Loan sanctioned, ready for booking",
        createdBy: "3",
        createdByName: "Amit Kumar",
        createdAt: new Date("2024-03-06"),
      },
...
export const communications = [
  {
    ...
    leadPhone: "+91 98765 11111",
    content:
      "Hello Mr. Khanna, this is Amit from PropFlow. Your site visit for Lodha Park is scheduled for tomorrow at 10 AM. Please confirm.",
    status: "delivered",
    sentBy: "3",
  ...
  },
  {
    ...
    content:
      "Dear Mr. Iyer, Please find attached the agreement copy for your review.",
    status: "delivered",
    sentBy: "3",
    sentByName: "Amit Kumar",
...
export const messageTemplates = [
  {
    ...
    type: "whatsapp",
    content:
      "Hello {{name}}, this is {{agent_name}} from PropFlow. Your site visit for {{project_name}} is scheduled for {{date}} at {{time}}. Please confirm.",
  ...
  },
  {
    ...
    type: "whatsapp",
    content:
      "Hi {{name}}, following up on our discussion about {{project_name}}. Are you still interested?",
  ...
  },
  {
    ...
    content:
      "Dear {{name}}, Congratulations! Your booking for {{unit_number}} at {{project_name}} has been confirmed.",
...
export const monthlyBookingsChartData = {
  ...
  datasets: [
    ...
    },
    {
      label: "Revenue (Cr)",
      data: [
        4.5, 7.2, 10.8, 9.5, 14.2, 17.1, 13.3, 15.2, 19.0, 20.9, 23.7, 26.6,
      ],
      color: "#ff8f35",
    },
  ],
