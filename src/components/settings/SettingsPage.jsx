    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="w-full md:w-64 flex-shrink-0 md:sticky md:top-24"
        >
...
function CompanySettings({ onSave }) {
  ...
  const [address, setAddress] = useState(
    "123, Business Hub, Bandra Kurla Complex",
  );
  ...
  return (
    <div>
      <SectionHeader
        ...
        desc="Manage your company details and legal information."
      />
      <Card>
        <CardContent className="p-6 space-y-5">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-0.5">
                PNG, JPG up to 2MB. Recommended 256×256
              </p>
          ...
          <div className="flex justify-end pt-2">
            <Button
              className="gap-2 bg-[#0082f3] hover:bg-[#2895f7]"
              onClick={onSave}
            >
      ...
      <Card className="mt-4">
        ...
        <CardContent className="px-6 pb-6 grid grid-cols-2 gap-4">
          {[
            {
              label: "Account Name",
              placeholder: "Next One Realty Pvt Ltd",
              defaultVal: "Next One Realty Pvt Ltd",
            },
            {
              label: "Account Number",
              placeholder: "XXXXXXXXXX",
              defaultVal: "1234567890123",
            },
            {
              label: "Bank Name",
              placeholder: "Bank name",
              defaultVal: "HDFC Bank",
            },
            {
              label: "IFSC Code",
              placeholder: "HDFC0001234",
              defaultVal: "HDFC0001234",
            },
            {
              label: "Branch",
              placeholder: "Branch name",
              defaultVal: "BKC, Mumbai",
            },
          ].map((f) => (
        ...
        <CardContent className="p-6 space-y-5">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <Badge className="mt-1 bg-blue-100 text-blue-700 text-xs capitalize">
...
function NotificationSettings({ onSave }) {
  const notifs = [
    ...
    },
    {
      ...
      desc: "When a lead status is updated",
      defaultOn: true,
    },
    {
      id: "followup_reminder",
      label: "Follow-up Reminders",
      desc: "Reminders for scheduled follow-up tasks",
      defaultOn: true,
    },
    {
      id: "site_visit",
      label: "Site Visit Alerts",
      desc: "Upcoming and completed site visit notifications",
      defaultOn: true,
    },
    {
      id: "booking",
    ...
    },
    {
      ...
      desc: "Payment received or overdue alerts",
      defaultOn: false,
    },
    {
      id: "commission",
      label: "Commission Credited",
      desc: "When commission is paid to your account",
      defaultOn: true,
    },
    {
      id: "team_activity",
          ...
          {[
            {
              ...
              desc: "Show notifications inside the CRM",
              on: true,
            },
            {
              icon: Smartphone,
              label: "Push Notifications",
              desc: "Mobile push notifications (requires mobile app)",
              on: false,
            },
            {
              icon: Mail,
              label: "Email Digest",
              desc: "Daily summary email at 8:00 AM",
              on: true,
            },
          ].map((ch, i) => (
            <div
                ...
                {[1, 2, 3, 4].map((i) => (
                  <div
                    ...
                    className={cn(
                      ...
                      newPw.length > i * 3 ? "bg-emerald-500" : "bg-gray-200",
                    )}
                  />
                ))}
              </div>
  ...
  return (
    <div>
      <SectionHeader
        ...
        desc="Manage what each role can access within the CRM."
      />
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-1.5 mt-2">
                  {perms.map((p) => (
                    <span
                      key={p}
                      className="text-xs px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-700 flex items-center gap-1"
                    >
...
function AppearanceSettings({ onSave }) {
  ...
  return (
    <div>
      <SectionHeader
        title="Appearance"
        desc="Personalise the look and feel of your CRM."
      />
      <Card>
              ...
              {[
                ...
                >
                  <t.icon
                    className={cn(
                      "w-5 h-5",
                      theme === t.val ? "text-[#0082f3]" : "text-gray-500",
                    )}
                  />
                  <span
                    className={cn(
                      "text-sm font-medium",
                      theme === t.val ? "text-[#0082f3]" : "text-gray-700",
                    )}
                  >
                    {t.label}
                  </span>
              ...
              {[
                {
                  val: "comfortable",
                  label: "Comfortable",
                  desc: "More spacing, easier to read",
                },
                {
                  val: "compact",
                  label: "Compact",
                  desc: "Tighter spacing, see more data",
                },
              ].map((d) => (
                <button
                  key={d.val}
                ...
                >
                  <p
                    className={cn(
                      "text-sm font-medium",
                      density === d.val ? "text-[#0082f3]" : "text-gray-900",
                    )}
                  >
                    {d.label}
                  </p>
...
function DataSettings() {
  return (
    <div>
      <SectionHeader
        title="Data & Backup"
        desc="Export your data and manage system backups."
      />
      <Card>
          ...
          {[
            {
              ...
              desc: "Download all leads as CSV or Excel",
              action: "Export CSV",
              color: "bg-blue-500",
            },
            {
              title: "Export Bookings",
              desc: "Download all bookings and transaction records",
              action: "Export CSV",
              color: "bg-purple-500",
            },
            {
              title: "Export Commission Report",
              desc: "Download commission statements",
              action: "Export PDF",
              color: "bg-emerald-500",
            },
            {
              title: "Full Data Backup",
              desc: "Download complete CRM data backup (JSON)",
            ...
            <div
              key={i}
              className={cn(
                "flex items-center gap-4 p-4 rounded-xl bg-gray-50",
        ...
        <CardContent className="px-6 pb-6 space-y-3">
          <div className="flex items-center justify-between p-3 rounded-xl border border-red-100 bg-red-50/50">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-0.5">
                Remove all mock data and start fresh
              </p>
            </div>
            <Button
              variant="outline"
