            ...
            <CardContent className="pt-0">
              <div className="space-y-4 max-h-[280px] overflow-y-auto pr-2 pb-2">
                {[
                  ...
                  { type: 'booking', action: 'New booking', detail: 'Karthik Menon - Unit T-301', time: '2 hours ago', icon: FileText, color: 'bg-purple-500' },
                  { type: 'payment', action: 'Payment received', detail: '₹10,00,000 - Token amount', time: '3 hours ago', icon: IndianRupee, color: 'bg-emerald-500' },
                  { type: 'commission', action: 'Commission credited', detail: '₹92,400 - BK-2024-0001', time: '5 hours ago', icon: TrendingUp, color: 'bg-pink-500' },
                  { type: 'call', action: 'Call completed', detail: 'Meera Reddy - 8 minutes', time: '6 hours ago', icon: Phone, color: 'bg-orange-500' },
                ].map((activity, index) => (
