...
export function CommunicationHub() {
  ...
  const {
    ...
    addItem: addCommunication,
    removeItem: removeCommunication,
  } = useLocalEntityStore("communications", communications);
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          >
                            <TypeIcon
                              className={cn(
                                "w-5 h-5",
                                typeColors[comm.type].replace("bg-", "text-"),
                              )}
                            />
                          </div>
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-4 mt-2">
                              ...
                              {comm.duration && (
                                <span className="text-sm text-gray-500">
                                  Duration: {Math.floor(comm.duration / 60)}m{" "}
                                  {comm.duration % 60}s
                                </span>
                              )}
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                <div className="flex gap-2">
                  <Button
                    variant={
                      selectedType === "whatsapp" ? "default" : "outline"
                    }
                    size="sm"
                    className={cn(
                      "gap-1",
                      selectedType === "whatsapp" &&
                        "bg-[#0082f3] hover:bg-[#2895f7]",
                    )}
              ...
              <div className="flex justify-between items-center">
                ...
                <Button
                  className="bg-[#0082f3] hover:bg-[#2895f7] gap-2"
                  onClick={handleSend}
                >
